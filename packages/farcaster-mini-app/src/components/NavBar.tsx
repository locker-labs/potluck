        ...
        <div className="flex items-center justify-end gap-5">
          <Link href="/docs" rel="noopener noreferrer">
            <div className="flex items-center justify-center gap-0.5 group">
              <BookText
                size={16}
                className="text-app-light group-hover:text-white transition-colors duration-150"
              />
              <span className="text-[14px] font-medium text-app-light group-hover:text-white transition-colors duration-150">
                Docs
              </span>
            </div>
          </Link>
