...
export default function Hero() {
  ...
  return (<div className="relative mb-[48px] mt-[14px] flex flex-col items-center justify-center px-4 border border-gray-700 rounded-[12px] pt-7 pb-5 shadow-lg bg-gradient-to-r from-gray-800 to-purple-900">
        <Image
