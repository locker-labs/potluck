  ...
  return (
    <div>
      ...
      {!isConnected || !address ? (
        ...
        <div
          className={
            "w-full h-[213px] flex flex-col items-center justify-center"
          }
        >
          <GradientButton4
            isActive={true}
          ...
          <p className={"text-sm text-cyan-400 mt-2"}>
            Connect your wallet to see your pots
          </p>
        </div>
        ...
        loading ? (
          ...
          <div
            className={
              "w-full h-[223px] flex flex-col items-center justify-center"
            }
          >
            <Loader2
          ...
          >
            <span className={"text-md font-medium text-cyan-400 mt-2"}>
              Oops!
            </span>
            <span className={"text-md text-cyan-400 mt-2"}>
              No pots = No savings
            </span>
            <span className={"text-md text-cyan-400"}>
              Start saving 👇 today
            </span>
          </div>
        )
